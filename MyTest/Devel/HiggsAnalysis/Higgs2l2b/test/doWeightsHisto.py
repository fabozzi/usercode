...
errArray_EleWPLoose = [
                        [0.0039, 0.018, 0.004, 0.002, 0.001, 0.002],   # 0.00 < eta < 0.80  
                        [0.040, 0.020, 0.005, 0.002, 0.002, 0.003],   # 0.80 < eta < 1.44 
                        [0.036, 0.077, 0.0022, 0.007, 0.008, 0.013],   # 1.44 < eta < 1.56
                        [0.065, 0.028, 0.008, 0.004, 0.003, 0.005],   # 1.56 < eta < 2.00
                        [0.074, 0.033, 0.010, 0.005, 0.004, 0.007]    # 2.00 < eta < 2.50
                      ]
