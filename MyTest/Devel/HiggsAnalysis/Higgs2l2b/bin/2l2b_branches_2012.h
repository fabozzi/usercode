...
//if(debug) cout<<"lepton id branhces for 2012 run "<<endl;
...
//if(debug)cout<<"lepton id branches for 2012 run "<<endl;
...
//  BRANCHBOOL(passDoubleElTrig);
 ...
 //if(debug)cout<<"lepton id branches: mva and beta "<<endl;
...
BRANCH(elHiggsLeptDau2EcalEn);
 BRANCH(elHiggsEleDau1hasMatchConv); 
 BRANCH(elHiggsEleDau2hasMatchConv); 
 BRANCH(elHiggsEleDau1mHits); 
 BRANCH(elHiggsEleDau2mHits); 
